...
Estado: workflow preparado en la raíz Git, ../../../.github/workflows/ci.yml. Este directorio interior no es donde GitHub descubre los workflows. Falta publicarlo y comprobar una ejecución remota satisfactoria.
